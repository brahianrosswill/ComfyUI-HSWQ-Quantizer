...
# SDXLHSWQQuantizerLegacy.py (元 V1.0r) の末尾

NODE_CLASS_MAPPINGS = {
    # キーを変更して、V1.5と重複しないようにする
    "HSWQFP8ConverterNodeLegacy": HSWQFP8ConverterNode 
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "HSWQFP8ConverterNodeLegacy": "HSWQ FP8 Converter (Legacy V1.0)"
}